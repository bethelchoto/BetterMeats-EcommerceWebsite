...
if(isset($_GET['cat_id'])) {
    ...
    $productsfound = show_by_cat($cat_id);
}
                ...
                <div class="tab-class text-center">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-8 text-end">
                            ...
                            <li class="nav-item">
                                <a class="d-flex m-2 py-2 bg-light rounded-pill active" data-bs-toggle="pill" href="#tab-1" onclick="window.location.href='index.php'">
                                    ...
                                    <div class="row g-4">
                                        <?php   
                                            ...
                                            if (empty($productsfound)) {
                                                // show a page with error mssg nothing to show
                                                return null;
                                                        ...
                                                        <div class="rounded position-relative fruite-item">
                                                            ...
                                                            <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                                                ...
                                                                <div class="d-flex justify-content-between flex-lg-wrap">
                                                                    ...
                                                                    <a href="index.php?add_to_cart=<?php echo trim($product['product_id']); ?>" class="btn border border-secondary rounded-pill px-3 text-primary">
